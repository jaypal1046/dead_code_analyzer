...
void multifilefunctionAnalyzerTest() {
  ...
  assert(
    functions.length == 10,
    'Expected 10 functions, got ${functions.length}',
  );

  // Commented functions from file1.dart
  assert(
    functions.containsKey('commentedFunction_commented_lib_src_file1_dart_2_8'),
  ...
  assert(
    functions.containsKey(
      'commentedFunction1_commented_lib_src_file1_dart_3_0',
    ),
  ...
  assert(
    functions.containsKey(
      'commentedFunction2_commented_lib_src_file1_dart_4_0',
    ),
  ...
  assert(
    functions.containsKey('commentedFunction_commented_lib_src_file2_dart_2_8'),
  ...
  assert(
    functions.containsKey(
      'commentedFunction1_commented_lib_src_file2_dart_3_0',
    ),
  ...
  assert(
    functions.containsKey(
      'commentedFunction2_commented_lib_src_file2_dart_4_0',
    ),
  ...
  assert(
    functions['activeFunction']!.definedInFile == 'lib/src/file1.dart',
    'Expected activeFunction from file1.dart to have correct file path',
  );
  assert(
    functions.containsKey('activeFunction_lib_src_file2_dart'),
    'Expected activeFunction from file2.dart to be detected',
  );
  assert(
    !functions['activeFunction_lib_src_file2_dart']!.commentedOut,
  ...
  assert(
    functions.containsKey('entryPointFunction_lib_src_file2_dart'),
